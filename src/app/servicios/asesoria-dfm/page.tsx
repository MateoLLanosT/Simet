        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div className="simet-split" style={{ display: "grid", gridTemplateColumns: "1.05fr 0.95fr", gap: 56, alignItems: "center" }}>
            <div className="simet-split-content">
              <h2>Fabricabilidad real: menos costos, cero retrabajos</h2>
              <p>
            ...
            <div className="simet-image-wrapper">
              <Image
                ...
                alt="Componentes mecánicos de precisión"
                fill
      ...
      <section style={{ padding: "30px 0 60px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div className="simet-section-header">
            <h2 className="simet-section-title">Ejes de Optimización y Asesoría en Manufactura</h2>
          </div>
      ...
      <section id="banner" style={{ padding: "20px 0 70px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div className="simet-cta-card">
            <h2>¿Desea optimizar los costos de sus planos o piezas actuales?</h2>
            <p>Envíenos sus requerimientos técnicos o planos preliminares para una revisión de fabricabilidad sin costo ni compromiso.</p>
          </div>
        </div>
      </section>
    </>
