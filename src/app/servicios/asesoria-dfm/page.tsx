...
export default function AsesoriaDfmPage() {
  return (
    <>
      {/* 1. HERO CON IMAGEN DE FONDO & GLASS */}
      <section
        style={{
          position: "relative",
          background:
            "linear-gradient(125deg, rgba(6, 17, 30, 0.95) 0%, rgba(11, 33, 56, 0.9) 60%, rgba(6, 17, 30, 0.94) 100%), url('https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=1920&q=85') center/cover no-repeat",
          color: "var(--white)",
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 2 }}>
          <div style={{ maxWidth: 940, margin: "0 auto", textAlign: "center" }}>
            ...
            >
              ...
              />
              CONSULTORÍA TÉCNICA DFM &amp; COSTOS
            </span>
            ...
            >
              Asesoría Técnica en Diseño para Manufactura (DFM) y Optimización de Costos
            </h1>
            ...
            >
              Reduzca costos de producción, evite retrabajos en taller y optimice la viabilidad técnica
              de sus piezas antes de encender un centro CNC o el láser.
            </p>
            ...
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
              ...
              >
                Solicitar Revisión Técnica de Planos
              </a>
      ...
      {/* 2. FABRICABILIDAD (SPLIT CON IMAGEN + BADGE TÉCNICO GLASS) */}
      <section style={{ padding: "95px 0", backgroundColor: "#f8fafc" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            <div className="simet-split-content">
              <span
                style={{
                  fontSize: "0.82rem",
                  fontWeight: 700,
              ...
              >
                Fabricabilidad real: menos costos, cero retrabajos
              </h2>
              <p
                style={{
                  fontSize: "1.025rem",
              ...
              >
                ...
                maquinado hasta en un <strong>50%</strong>.
              </p>
              <p
                style={{
                  fontSize: "1.025rem",
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                {["Ajuste de radios CNC", "Desarrollo para Láser", "Ahorro en Material"].map((item) => (
                  <span
                    key={item}
                    style={{
                      display: "inline-flex",
            ...
            >
              <Image
                ...
                alt="Auditoría de planos y maquinado DFM"
                fill
              ...
              >
                <div>
                  ...
                  <strong style={{ fontSize: "0.95rem" }}>Diagnóstico de Fabricabilidad SIMET</strong>
                </div>
                <span
                  style={{
      ...
      {/* 3. EJES DE OPTIMIZACIÓN (TARJETAS GLASS CON IMÁGENES PREVIEW) */}
      <section id="ejes" style={{ padding: "85px 0 75px", backgroundColor: "#ffffff" }}>
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px" }}>
          <div className="simet-section-header" style={{ maxWidth: 760, margin: "0 auto 55px", textAlign: "center" }}>
            ...
            <h2 className="simet-section-title" style={{ fontSize: "clamp(2rem, 3.2vw, 2.6rem)", color: "#0f172a" }}>
              Ejes de Optimización y Asesoría en Manufactura
            </h2>
          </div>

          <div className="simet-grid-4" style={{ gap: 24 }}>
            {optimizationAxes.map((c) => (
              <article
                key={c.title}
                style={{
                  background: "rgba(255, 255, 255, 0.8)",
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 2, maxWidth: 840, margin: "0 auto" }}>
              ...
              >
                ¿Desea optimizar los costos de sus planos o piezas actuales?
              </h2>
              <p
                style={{
                  fontSize: "1.1rem",
              ...
              >
                Envíenos sus requerimientos técnicos o planos preliminares (DWG, DXF, STEP, PDF) para una
                revisión de fabricabilidad sin costo ni compromiso.
              </p>
