...
export default function Modelado3DPage() {
  return (
    <>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 2 }}>
          <div style={{ maxWidth: 940, margin: "0 auto", textAlign: "center" }}>
            ...
            >
              ...
              />
              INGENIERÍA DIGITAL &amp; MODELADO CAD/CAM
            </span>
      ...
      {/* 2. PRECISIÓN MECÁNICA (SPLIT CON IMAGEN + CHIP TÉCNICO GLASS) */}
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            <div className="simet-precision-content">
              ...
              >
                DESARROLLO CAD/CAM ORIENTADO A TALLER
              </span>
              <h2
                style={{
                  color: "#0f172a",
              ...
              >
                Precisión desde el plano digital hasta el taller
              </h2>
              <p
                style={{
                  fontSize: "1.025rem",
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                {["Formatos STEP, IGES, DXF", "Normas ISO / ASME", "Simulación Cinemática"].map((item) => (
                  <span
                    key={item}
                    style={{
                      display: "inline-flex",
            ...
            >
              <Image
                ...
                alt="Control CNC de precisión y diseño 3D"
                fill
              ...
              >
                <div>
                  ...
                  <strong style={{ fontSize: "0.95rem" }}>Tolerancias dimensionales milimétricas</strong>
                </div>
                <span
                  style={{
      ...
      {/* 3. CAPACIDADES CAD (TARJETAS GLASS CON PREVIEWS FOTOGRÁFICOS) */}
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px" }}>
          <div className="simet-section-header" style={{ maxWidth: 760, margin: "0 auto 55px", textAlign: "center" }}>
            ...
            <h2 className="simet-section-title" style={{ fontSize: "clamp(2rem, 3.2vw, 2.6rem)", color: "#0f172a" }}>
              Capacidades de Diseño e Ingeniería CAD
            </h2>
          </div>
        ...
        <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px" }}>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 2, maxWidth: 840, margin: "0 auto" }}>
              ...
              >
                DIGITALIZACIÓN &amp; PLANOS DE TALLER
              </span>
              <h2
                style={{
              ...
              >
                ¿Tiene un plano o pieza que requiere modelado de precisión?
              </h2>
              <p
                style={{
                  fontSize: "1.1rem",
              ...
              >
                Envíenos sus requerimientos técnicos, croquis o muestras físicas para una evaluación y levantamiento dimensional sin costo.
              </p>
